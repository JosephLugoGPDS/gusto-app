...
class _$TasteDetailModelImpl implements _TasteDetailModel {
  ...
  @override
  String toString() {
    return 'TasteDetailModel(id: $id, name: $name, description: $description, category: $category, imageUrl: $imageUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, category, imageUrl);
...
abstract class _TasteDetailModel implements TasteDetailModel {
  const factory _TasteDetailModel(
      ...
      final String? description,
      final String? category,
      final String? imageUrl}) = _$TasteDetailModelImpl;
